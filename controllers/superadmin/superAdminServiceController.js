...
//   try {
//     const service = await SuperAdminService.create(req.body);
...
// // 📌 Get All Services (Private Dashboard)
// export const getSuperServicesPrivate = async (req, res) => {
//   try {
//     const services = await SuperAdminService.find().sort({ createdAt: -1 });
...
//   try {
//     const services = await SuperAdminService.find({ status: true });
//     res.json({ success: true, services });
//   } catch (err) {
//     res.status(500).json({ message: err.message });
//   }
...
//   try {
//     const service = await SuperAdminService.findByIdAndUpdate(
//       req.params.id,
//       req.body,
//       { new: true }
//     );
...
//   try {
//     await SuperAdminService.findByIdAndDelete(req.params.id);
...
//   try {
//     const service = await SuperAdminService.findById(req.params.id);

import{ah as a,j as e}from"./index-CZT2epyM.js";import{C as o}from"./circle-check-B9RZKwzX.js";import"./createLucideIcon-8m28Lugg.js";function u(){const{data:l,isLoading:i}=a();if(i)return null;const r=l?.about;if(!r)return null;const n=s=>{const t=document.getElementById(s);t&&t.scrollIntoView({behavior:"smooth"})};return e.jsxs("section",{id:"about",className:`\r
      ...
      `,children:[e.jsx("div",{className:`absolute -top-32 right-0 w-[360px] h-[360px] \r
        ...
        grid md:grid-cols-2 gap-16 items-center`,children:[r.image&&e.jsxs("div",{className:"relative group",children:[e.jsx("div",{className:`absolute -inset-4 rounded-3xl \r
            ...
            `,children:r.subtitle}),e.jsx("h2",{className:"text-4xl sm:text-5xl font-bold leading-tight text-[#0B1220]",children:r.title}),e.jsx("p",{className:"text-gray-600 text-lg leading-relaxed max-w-xl",children:r.description}),e.jsx("div",{className:"grid sm:grid-cols-2 gap-4 pt-2",children:r.features?.map((s,t)=>e.jsxs("div",{className:`\r
                ...
                `,children:[e.jsx(o,{className:"text-blue-600 w-5 h-5 mt-1 shrink-0"}),e.jsx("p",{className:"text-gray-700 text-sm font-medium",children:s.text})]},t))}),e.jsx("button",{onClick:()=>n("services"),className:`\r
              ...
              transition\r
            `,children:"Explore Our Services"})]})]})]})}export{u as default};

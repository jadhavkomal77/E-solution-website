import{e as n,aj as c,j as e}from"./index-CLIh4Pj0.js";import{L as x}from"./loader-circle-C8dWH4Xu.js";import{C as o}from"./circle-alert-C7KFFfg_.js";import{S as d,C as m}from"./sparkles-Ds71V6eh.js";import"./createLucideIcon-B2OUqNTq.js";function f(){const t=n(),{data:a,isLoading:l,isError:i}=c(),r=a?.products||[];return l?e.jsx("section",{id:"products",className:"py-24 bg-[#F8FAFC]",children:e.jsx("div",{className:"flex justify-center min-h-[50vh] items-center",children:e.jsxs("div",{className:"flex flex-col items-center gap-3",children:[e.jsx(x,{className:"w-8 h-8 text-blue-600 animate-spin"}),e.jsx("p",{className:"text-gray-500 font-medium",children:"Loading products…"})]})})}):i?e.jsx("section",{id:"products",className:"py-24 bg-[#F8FAFC]",children:e.jsx("div",{className:"flex justify-center min-h-[50vh] items-center",children:e.jsxs("div",{className:"flex flex-col items-center gap-3 text-center",children:[e.jsx(o,{className:"w-10 h-10 text-red-500"}),e.jsx("p",{className:"text-red-600 font-semibold",children:"Failed to load products"})]})})}):r.length?e.jsxs("section",{id:"products",className:"relative py-8 bg-[#F8FAFC] overflow-hidden scroll-mt-28",children:[e.jsx("div",{className:`absolute inset-0 opacity-[0.025]\r
        ...
        [background-size:48px_48px]`}),e.jsxs("div",{className:"relative z-10 max-w-7xl mx-auto px-6",children:[e.jsxs("div",{className:"max-w-3xl mx-auto text-center mb-20",children:[e.jsxs("div",{className:`inline-flex items-center gap-2 px-4 py-2\r
            ...
            text-sm font-semibold mb-6`,children:[e.jsx(d,{size:16}),"Premium Technology"]}),e.jsxs("h2",{className:"text-4xl sm:text-5xl font-extrabold text-[#0B1220] mb-5",children:["Enterprise-Grade"," ",e.jsx("span",{className:"text-blue-600",children:"Products"})]}),e.jsx("p",{className:"text-gray-600 text-lg",children:"Carefully curated solutions built for performance, security and long-term scalability."})]}),e.jsx("div",{className:"grid sm:grid-cols-2 lg:grid-cols-3 gap-8",children:r.map(s=>e.jsxs("div",{className:`\r
              ...
              `,children:e.jsx("img",{src:s.image,alt:s.name,className:`\r
                  ...
                  `})}),e.jsxs("div",{className:"p-7 flex flex-col",children:[e.jsx("h3",{className:"text-xl font-bold text-[#0B1220] mb-3",children:s.name}),e.jsx("p",{className:"text-gray-600 text-sm mb-6 line-clamp-2",children:s.description}),e.jsxs("div",{className:"flex items-center justify-between mt-auto pt-5 border-t",children:[e.jsxs("span",{className:"text-2xl font-bold text-blue-600",children:["₹",s.price]}),e.jsxs("button",{onClick:()=>t(`/superproducts/enquiry/${s._id}`),className:`\r
                    ...
                    `,children:["Enquiry",e.jsx(m,{size:16})]})]})]})]},s._id))})]})]}):null}export{f as default};
